...
<legend></legend>
		<div class="form-group">
		  ...
		  <div class="col-md-8">
		  <input id="title" name="title" type="text" placeholder="Escriba aqui" class="form-control input-md" required="">
		    </div>
		  </div>
		  <div class="form-group">
		  <label class="col-md-3 control-label" for="body">Descripcion </label>  
		  <div class="col-md-8">
		  <input id="body" name="body" type="text" placeholder="Escriba aqui" class="form-control input-md" required="">
		    </div>
		  </div>
		  <div class="form-group">
		  <label class="col-md-3 control-label" for="source">Fuente</label>  
		  <div class="col-md-8">
		  <input id="source" name="source" type="text" placeholder="Escriba aqui" class="form-control input-md" required="">
